...
contract ConditionalTokens is State, ERC1155 {
    ...
    mapping(address => bool) public userRedeemRecords;
    bool public isReportPayouts = false;
    ...
    bytes32 public publicQuestionId;
    address public publicOracle;
    uint public publicOutcomeSlotCount;
    ...
    /// @param questionId An identifier for the question to be answered by the oracle.
    /// @param outcomeSlotCount The number of outcome slots which should be used for this condition. Must not exceed 256.
    function prepareCondition(address oracle, bytes32 questionId, uint outcomeSlotCount) external onlyOwner {
        publicQuestionId = questionId;
        publicOracle = oracle;
        publicOutcomeSlotCount = outcomeSlotCount;
    ...
    function redeemPositions(IERC20 collateralToken, bytes32 parentCollectionId, bytes32 conditionId, uint[] calldata indexSets) external {
        ...
        userRedeemRecords[msg.sender] = true;
    ...
    function getSimpleConditionId() external view returns (bytes32) {
        return CTHelpers.getConditionId(publicOracle, publicQuestionId, publicOutcomeSlotCount);
    }
